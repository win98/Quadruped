...
#define	wifi_cmd_hardware_uart_conf_id                 	(((uint32)wifi_dev_type_wifi)|wifi_msg_type_cmd|0x0E060000)
...
#define	wifi_rsp_hardware_uart_conf_id                 	(((uint32)wifi_dev_type_wifi)|wifi_msg_type_rsp|0x0E060000)
...
PACKSTRUCT(struct wifi_cmd_packet
{
	uint32   header;
 union{
	uint8 handle;
	...
	struct wifi_msg_hardware_uart_conf_cmd_t                  cmd_hardware_uart_conf;
	...
	struct wifi_msg_hardware_uart_conf_rsp_t                  rsp_hardware_uart_conf;
...
/**Configure UART**/
#define wifi_cmd_hardware_uart_conf(ID,RATE,DATA_BITS,STOP_BITS,PARITY,FLOW_CTRL) \
{\
bglib_temp_msg.cmd_hardware_uart_conf.id=ID;\
bglib_temp_msg.cmd_hardware_uart_conf.rate=RATE;\
bglib_temp_msg.cmd_hardware_uart_conf.data_bits=DATA_BITS;\
bglib_temp_msg.cmd_hardware_uart_conf.stop_bits=STOP_BITS;\
bglib_temp_msg.cmd_hardware_uart_conf.parity=PARITY;\
bglib_temp_msg.cmd_hardware_uart_conf.flow_ctrl=FLOW_CTRL;\
